...
if __name__ == '__main__':
    ...
    if (hl2ss.StreamPort.RM_DEPTH_LONGTHROW in ports):
        ...
        outputpath = f'{path}/personal_video'
        Path(outputpath).mkdir(parents=True, exist_ok=True)
        hl2ss_utilities.unpack_to_pv_depth(filenames[hl2ss.StreamPort.PERSONAL_VIDEO],
                                           filenames[hl2ss.StreamPort.RM_DEPTH_LONGTHROW], outputpath)
